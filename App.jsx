      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        <div className="grid md:grid-cols-3 lg:grid-cols-4 gap-8">
          {[
            ...
            { img: "/Images/1.jpg", color: "from-orange-300 to-orange-500", name: "Ashima Ma'am", role: "Social Studies Instructor", desc: "With over 10 years of teaching experience, Ashima Ma'am inspires students to understand society and history critically." },
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-16">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a
                      ...
                      className="inline-block mt-2 text-sm text-orange-500 hover:text-orange-600 font-semibold underline underline-offset-2"
                    >
                      Open in Google Maps →
                    </a>
                  </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg overflow-hidden relative" style={{ height: '500px' }}>
              ...
              ></iframe>
              {/* Floating button to open exact location */}
              <a
                href="https://maps.app.goo.gl/TCSekArxysGqg93e8"
                target="_blank"
                rel="noopener noreferrer"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-5 gap-8 mb-8">
            <div className="col-span-2 md:col-span-1">
              ...
              <p className="text-gray-600 text-sm">Excellence in coaching since 1987.</p>
            </div>
            <div>
